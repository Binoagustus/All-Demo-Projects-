package com.springappdemo.springjwt.security.services;
...
import com.springappdemo.springjwt.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
	...
	public RefreshToken verifyExpiration(RefreshToken token) {
		if (token.getExpiryDate().compareTo(Instant.now()) < 0) {
			...
			throw new JWTSecurityException(token.getToken(),
